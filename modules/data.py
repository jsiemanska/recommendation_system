...
ratings_train, ratings_test = train_test_split(df, test_size=0.002, random_state=10)
ratings_valid, ratings_test = train_test_split(ratings_test, test_size=0.5, random_state=10)
